...
#cmd('echo useradd -m -g users -G wheel,audio,video,games,power -s /bin/bash -c "' + rea + '" ' + use + ' >> /mnt/setup.sh')
cmd('echo useradd -m -g users -G wheel,audio,video,games,power -s /bin/bash ' + use + ' >> /mnt/setup.sh')
...
cmd('tput setaf 1 >> /mnt/setup.sh')
cmd('echo "echo First enter - exit - into the command prompt!" >> /mnt/setup.sh')
cmd('echo "echo Then enter - shutdown now - into the command prompt!" >> /mnt/setup.sh')
cmd('tput sgr0 >> /mnt/setup.sh')
